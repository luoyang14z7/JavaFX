    ...
    @FXML private Button login;
       ...
       public void adminlogin(ActionEvent event) {
        ...
        try {
            ...
            Parent anotherRoot = FXMLLoader.load(getClass().getResource("dingdanGuanli.fxml"));
            Stage anotherStage = new Stage();
            anotherStage.setTitle("订单管理");
            anotherStage.setScene(new Scene(anotherRoot, 1040, 950));
